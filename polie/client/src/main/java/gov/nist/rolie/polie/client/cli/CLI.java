...
package gov.nist.rolie.polie.client.cli;

import gov.nist.rolie.polie.client.operation.CommandTypeEnum;
...
public class CLI {
  ...
  private ExitStatus processCommand(String[] args) {
    ...
    try {
      ...
      operation.parseOptions(Arrays.copyOfRange(args, 2, args.length));
