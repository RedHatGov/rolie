...
public class EntryGet extends AbstractEntryOperation {
  ...
  public ExitStatus execute(String[] args) {
    try {
      ...
      return ExitCode.INPUT_ERROR.toExitStatus("The URL you have entered is malformed");
    } catch (IOException e) {
      return ExitCode.INPUT_ERROR.toExitStatus("The URL you have entered is not responding or is not a ROLIE repo.");
    }
