 ...
 * Government. Pursuant to title 17 United States Code Section 105, works of
 * NIST employees are not subject to copyright protection in the United States
 ...
 * PROVIDED HEREUNDER.
 */
@javax.xml.bind.annotation.XmlSchema(namespace = gov.nist.jrolie.model.Constants.ATOM_NS, xmlns = {
		@XmlNs(prefix = "rolie", namespaceURI = gov.nist.jrolie.model.Constants.ROLIE_NS),
		@XmlNs(prefix = "", namespaceURI = gov.nist.jrolie.model.Constants.ATOM_NS),
		@XmlNs(prefix = "app", namespaceURI = gov.nist.jrolie.model.Constants.APP_NS) }, elementFormDefault = javax.xml.bind.annotation.XmlNsForm.QUALIFIED)
