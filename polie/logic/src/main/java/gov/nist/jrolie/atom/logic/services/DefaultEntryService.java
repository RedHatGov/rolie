...
public class DefaultEntryService implements EntryService {
	...
	@Override
	public JEntry load(String id)
			throws ResourceNotFoundException, InvalidResourceTypeException {
		return pc.load(id, JEntry.class);
	}

	@Override
	public JEntry create(JEntry resource) throws ResourceAlreadyExistsException {
	...
	@Override
	public JEntry update(JEntry resource) throws ResourceNotFoundException {
