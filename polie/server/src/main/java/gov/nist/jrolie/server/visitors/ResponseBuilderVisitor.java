...
/**
 * This visitor provides the common final steps of response preparation before
 * the request is sent out. Most of the work is done automatically by the
 * server, but any extra logic is done here. This should be a late visitor, or
 * the last.
 *
 * @author sab3
 *
...
public class ResponseBuilderVisitor implements RESTEventVisitor {
	...
	/**
	 * When this visitor encounters a GET request, it gets the resource that has
	 * been found and places it in the body of the response.
	 * 
	 * 
	...
	public boolean visit(Get get, ResponseBuilder rb, Map<String, Object> data) {
		final JResource resource = (JResource) data.get(RESOURCE_KEY);
		rb.entity(resource);
		rb.header("ETag", resource.hashCode());
		return true;
	}

	/**
	 * When this visitor encounters a post request, it gets the resource that has
	 * been created and places it in the body of the response.
	 * 
	 * 
	 * 
	...
	/**
	 * When this visitor encounters a PUT request, it gets the resource that has
	 * been updated and places it in the body of the request.
	 * 
