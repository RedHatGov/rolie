...
/**
 * Handles incoming request validation. Should be placed first or very early in
 * the execution list. Most of the request validation is handled automatically
 * by the server. This is for extra validation logic.
 */
@Component
