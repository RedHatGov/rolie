...
/**
 * Primary driver of resource requests in POLIE, aka "Where the magic happens". Consolidated in one
 * visitor because the request type implies the valid resource types.
 * 
 * @author sab3
 *
 */
